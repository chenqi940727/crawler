...
//        return new SFTPUtil("root", "TzDFVbq%@20180323Zm", "60.255.156.98", 22);
    ...
    public static void main(String[] args) throws SftpException, IOException {
        ...
        String filename = UUID.randomUUID().toString().substring(0, 8) + System.currentTimeMillis() + (int) (Math.random() * 1000) + ".jpg";
        ...
        try {
            ...
            System.out.println("获取图片inputstream失败");
            throw e;
        }finally {
            if(is != null){
                is.close();
