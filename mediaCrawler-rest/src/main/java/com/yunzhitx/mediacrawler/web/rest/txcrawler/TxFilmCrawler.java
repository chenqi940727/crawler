 ...
 * @description: TODO
 * @author: 陈奇
 * @createAt Date: 2018/7/17$-13:48$
 * @modificationHistory: who  when  what
 * ---------     -------------   --------------------------------------
 **/
public class TxFilmCrawler extends BreadthCrawler {
     ...
     */
    public TxFilmCrawler(String crawlPath, boolean autoParse, BaseRedisDao redisDao) {
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        for(Element tv : tvList){
            ...
            redisDao.addList(RedisKey.TX_FILM_ALBUMID_LIST, txTvId);
